...
<!-- Slideshow - Static content Text with register + bottom mask style 3 -->
                    ...
                    <div class="kl-slideshow-safepadding sc__container ptop-230">
                        ...
                        <div class="static-content default-style static-content--with-login">
                            ...
                            <!--/ social-icons -->
                                    ...
                                    <!-- Sub-title -->
                                    <h3 class="static-content__subtitle"><span class="fw-thin">This is a unique platform where you Give Smile (GS) as help to a fellow member of the community and have 100% returns as Receive Smile (RS).</h3>
                                ...
                                <hr class="hidden-md">
                                <center>
                                    <a class="h4 zn_sub_button btn btn-fullcolor hidden-md hidden-lg" href="<?php echo e(URL::to('/login')); ?>">Login</a>
                                </center>
                                <hr>
                                    <!-- Fancy register form -->
        ...
        <?php endif; ?>
                                ...
                                <?php endif; ?>
                                            ...
                                            <?php if(isset($referrer_name) && $referer_phone !='08161690210'): ?>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="user_password2">Referred by</label>
                                                <div class="col-sm-8">
                                                    <input id="" type="text" name="referrer_name" class="form-control inputbox" value="<?php echo e($referrer_name); ?>" disabled="disabled">
                                                </div>
                                            </div>
        ...
        <section class="hg_section bg-white ptop-65">
          ...
          <div class="">
          <div class="ac-buttons">
            <center><a class="btn  btn-danger  ac-btn" href="about.html" target="_blank">LEARN MORE</a></center>
         </div>
          </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="gobox gobox-first ">
                            ...
                            <div class="gobox-content">
                                ...
                                <!-- Description -->
                                <p>
                                    Sign up correctly by imputing valid credentials.
                                </p>
                                <!--/ Description -->
                            </div>
                            <!--/ Content -->
