      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <strong><i class="fa fa-book margin-r-5"></i>Amount</strong>
              ...
              <p class="text-muted"><?php echo e($match->gsmile->user->phone); ?></p>

              <hr>

              <strong><i class="fa fa-map-marker margin-r-5"></i>Sower's Account Name</strong>

              <p class="text-muted"><?php echo e($match->gsmile->user->account_name); ?></p>
              ...
              <p class="text-muted"><?php echo e($match->gsmile->user->account_no); ?></p>

              <hr>

              <strong><i class="fa fa-map-marker margin-r-5"></i>Sower's Bank</strong>

              <p class="text-muted"><?php echo e(ucwords($match->gsmile->user->bank)); ?>&nbsp; Bank</p>
...
$mins =  floor(  ($secondsLeft-($days*60*60*24) - ($hours*60*60))/60);
              ...
              <p>
               ...
               <a class="btn btn-default" href="<?php echo e(URL::to('/matches/extend_time/'.$match->id)); ?>">Extend time (24 hrs)</a>

               <?php endif; ?>
               <?php endif; ?>

               <?php if($timeLeft <= 0): ?>
               <a class="btn btn-danger" href="<?php echo e(URL::to('/matches/remove_defaulter/'.$match->id)); ?>">Remove defaulter</a>
               <?php endif; ?>
               ...
               <?php
                  $fParam=$match->id;
               ?>
                <a class="btn btn-md btn-danger <?php echo $disabled; ?>" href="<?php echo e(asset('public/uploads/'.$teller_link)); ?>" target='_blank' >View payment teller</a>
               <!--view payemnt teller-->
