<?php $__env->startSection('content'); ?>
   ...
   <a style="float:right" href="<?php echo e(URL::to('/admin/user/list')); ?>" class="btn btn-success">View all registered users</a>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Latest Registered Users&nbsp;<span class="badge"><?php echo e($userNo); ?></span>
