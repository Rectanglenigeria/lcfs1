						...
						<div class="row">
							...
							<div class="col-md-3 col-lg-3">
								<div class="call-to-action-btn">
									<a href="<?php echo e(URL::to('/register')); ?>" target="_blank" class="btn btn-lg btn-primary">Create Account!</a><span class="arrow hlb d-none d-md-block" data-appear-animation="rotateInUpLeft" style="top: -40px; left: 70%;"></span>
								</div>
							</div>
						</div>
					</div>
