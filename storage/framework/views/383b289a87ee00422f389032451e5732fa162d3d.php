 ...
 <!--refereer link-->
     ...
     <?php if(Session::has('notification')): ?>
        ...
        <div class="">
                ...
                <center><a href="<?php echo e(URL::to('/gsmile/create')); ?>"><button type="button" class="btn bg-olive btn-flat margin">Sow Laughter</button></a>

                <a href="<?php echo e(URL::to('/rsmile/create')); ?>"><button type="button" class="btn bg-olive btn-flat margin">Reap Laughter</button></a></center>
