        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="box-body table-responsive">
              ...
              <a class="btn btn-primary" href="<?php echo e(URL::to('/admin/user/make_teamlead/'.$user->id)); ?>">Make Team Lead</a>
               <?php else: ?>
               <a class="btn btn-primary" href="<?php echo e(URL::to('/admin/user/unmake_teamlead/'.$user->id)); ?>">Unmake Team Lead</a>
              <?php endif; ?>
