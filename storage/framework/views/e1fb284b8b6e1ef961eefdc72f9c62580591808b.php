                        ...
                        <div class="static-content default-style static-content--with-login">
                            <div class="row">
                                ...
                                <div class="col-sm-10 col-sm-offset-1 col-md-7 col-md-offset-0">
                                    <!-- Title -->
                                    <h2 class="static-content__title">LOGIN</h2>

                                    <!-- Sub-title -->
                                    <h3 class="static-content__subtitle"><span class="fw-thin">You are almost there...</h3>
                                </div>
                                ...
                                <div class="col-sm-10 col-sm-offset-1 col-md-5 col-md-offset-0">
                                    ...
                                    <div class="fancy_register_form">
                                        <!-- Title centered -->
                                        <h4 style="text-align:center">Login to your dashboard</h4>
        ...
        <?php endif; ?>
                                        ...
                                        <form name="login_form" method="POST" class="th-register-form register_form_static form-horizontal" role="form" action="<?php echo e(route('login')); ?>">
                                            ...
                                            <div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                                                <label class="col-sm-4 control-label" for="user_login">Phone</label>
                                                <div class="col-sm-8">
                                ...
                                <?php endif; ?>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                                <label class="col-sm-4 control-label" for="user_login">Password</label>
                                                <div class="col-sm-8">
                                                    <input name="password" type="password" value="<?php echo e(old('password')); ?>" id="password" class="form-control inputbox" required="" placeholder="Your password">
                                        ...
                                        <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> Remember Me
                                           ...
                                           <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-4" style="margin-bottom:0;">
                                                    <input type="submit" name="submit" class="zn_sub_button btn btn-fullcolor th-button-register" value="Login">

                                                   <!-- <a style="margin-left: -20px;" class="btn btn-link" href="<?php echo e(URL::to('/passwords/reset')); ?>">
                                    Forgot Your Password?
                                </a>--> or <a href="<?php echo e(URL::to('/passwords/reset')); ?>">Forget Password</a>
                                                </div>
