...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo e(asset('public/auth_pages/plugins/iCheck/square/blue.css')); ?>">
...
<!-- iCheck -->
<script src="<?php echo e(asset('public/auth_pages/plugins/iCheck/icheck.min.js')); ?>"></script>
<script>
  $(function () {
    $('input').iCheck({
