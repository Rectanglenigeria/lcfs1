...
$mins =  floor(  ($secondsLeft-($days*60*60*24) - ($hours*60*60))/60);
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <?php
                      if(!isset($transaction->gsmile_user->name)){
                        continue;
                      }
...
<?php if(isset($participant->gsmile_user->name) && $participant->gsmile_user->is_pioneer == '1'){continue;}?>

<?php if(isset($participant->payment_type) && $participant->payment_type == 0){continue;}?>

<?php if(isset($participant->payment_type) && $participant->payment_type == 2){continue;}?>
