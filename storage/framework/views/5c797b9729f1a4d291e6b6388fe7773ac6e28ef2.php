...
<option value="zenith">Zenith Bank</option>
        ...
        <?php if($errors->has('bank')): ?>
              ...
              <a class="btn btn-primary" href="<?php echo e(URL::to('/admin/user/make_teamlead/'.$user->id)); ?>">Make Legend</a>
               <?php else: ?>
               <a class="btn btn-primary" href="<?php echo e(URL::to('/admin/user/unmake_teamlead/'.$user->id)); ?>">Unmake Legend</a>
              <?php endif; ?>
