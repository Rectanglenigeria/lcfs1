<?php $__env->startSection('content'); ?>
   ...
   <!-- Main content -->
    ...
    <?php if(Session::has('notification')): ?>
       ...
       <!-- <a style="" href="<?php echo e(URL::to('/admin/trigger/automatch')); ?>" class="btn btn-xs btn-primary">Force automatch</a>-->

   <a style="" href="<?php echo e(URL::to('/admin/user/list')); ?>" class="btn btn-xs btn-success">View all registered users</a>


    <a style="" href="<?php echo e(URL::to('/admin/timeout/block')); ?>" title="run time out blockage">..</a>
       <a style="" href="<?php echo e(URL::to('/admin/updateMGI')); ?>">.</a>
