          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  <a href="<?php echo e(URL::to('/admin/register')); ?>" class="btn btn-default btn-xs">Add admin</a>
                </div>

                <div class="pull-left">
                  <a href="<?php echo e(URL::to('/admin/automatch/pause')); ?>" class="btn btn-default btn-xs">PA</a>
                </div>

                <div class="pull-left">
                  <a href="<?php echo e(URL::to('/admin/automatch/start')); ?>" class="btn btn-default btn-xs">LA</a>
                </div>

                <?php endif; ?>

                <div class="pull-left">
                  <a href="<?php echo e(URL::to('/admin/logout')); ?>" class="btn btn-default btn-xs">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
