...
<div class="alert alert-info alert-sm alert-dismissable">
            ...
            <ol>
            <li>
               Match RS requests to GS requests. This page lists out unmatched RS requests and partially matched RS requests.
            </li>

            <li>
               The manual matching is independent on 15 days period.
            </li>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <br>
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              Unmatched and Partially Matched RS Requests
