                        ...
                        <div class="static-content default-style static-content--with-login">
                            <div class="row">
                                ...
                                <div class="col-sm-10 col-sm-offset-1 col-md-7 col-md-offset-0">
                                    <!-- Title -->
                                    <h2 class="static-content__title">SMS VERIFICATION</h2>

                                    <!-- Sub-title -->
                                    <h3 class="static-content__subtitle"><span class="fw-thin">Just to ensure that you are not a robot.</h3>
                                </div>
        ...
        <?php endif; ?>
                                        ...
                                        <form name="sms_ver_form" method="POST" class="th-register-form register_form_static form-horizontal" role="form" action="<?php echo e(URL::to('/activate_user')); ?>">
                                            ...
                                            <div class="form-group<?php echo e($errors->has('code') ? ' has-error' : ''); ?>">
                                                <label class="col-sm-4 control-label" for="user_login">Code</label>
                                                <div class="col-sm-8">
                                                    <input type="hidden" name="user_id" value="<?php echo e($user_id); ?>">
                                                    <input name="code" type="text" value="<?php echo e(old('code')); ?>" id="code" class="form-control inputbox" required="" placeholder="SS56453" autofocus>
                                ...
                                <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-4" style="margin-bottom:0;">
                                                    <input type="submit" name="submit" class="zn_sub_button btn btn-fullcolor th-button-register" value="Verify">
                                                    <a href="<?php echo e(URL::to('/reVerify/'.$user_id)); ?>" class="btn-sm zn_sub_button btn btn-fullcolor th-button-register">
                                                        Resend code
                                                    </a>
                                                </div>
