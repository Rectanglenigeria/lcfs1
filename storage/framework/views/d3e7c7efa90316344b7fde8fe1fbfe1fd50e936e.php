        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              &nbsp;<span class="badge"><?php echo e($totalRefBonus); ?></span>
            </ul>
            ...
            <div class="tab-content no-padding">
              ...
              <?php else: ?>
              <a href="<?php echo e(URL::to('bonus/referer/receive/'.$bonus->id)); ?>" class="btn btn-primary btn-sm" role="button">Receive</a>
              <?php endif; ?>
