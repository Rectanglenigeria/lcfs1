      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <?php $__currentLoopData = $approvedTestimonies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimony): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           ...
           <?php
                  if(!isset($testimony->name)){continue;}
                ?>
            ...
            <iframe style="width:100%; height: 180px;" src="<?php echo e($testimony->video_link); ?>?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen>
            </iframe>
