              ...
              >
                  ...
                  <div class="form-group<?php echo e($errors->has('bank') ? ' has-error' : ''); ?> ">
                    ...
                    <div class="col-sm-10">
                      ...
                      <select class="form-control <?php if(!empty(Auth::user()->account_no)): ?>
              <?php echo e('hidden'); ?>

              <?php endif; ?>" name="bank" <?php if(!empty(Auth::user()->account_no)): ?>
              <?php echo e('disabled'); ?>
...
<option value="zenith">Zenith Bank</option>
        ...
        <?php if($errors->has('bank')): ?>
                  ...
                  <div class="form-group <?php if(!empty(Auth::user()->account_no)): ?>
              <?php echo e('hidden'); ?>
