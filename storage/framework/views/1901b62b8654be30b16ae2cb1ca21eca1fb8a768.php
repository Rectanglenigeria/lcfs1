<?php $__env->startSection('content'); ?>
   ...
   <!-- Main content -->
    ...
    <section class="content-header">
      <h1>
        SMILESTEADY
        <small>Dashboard&nbsp;|&nbsp;Welcome Administrator</small>
      </h1>
         </section>
    ...
    <?php if(Session::has('notification')): ?>
       ...
       <?php if(!empty($automatchStatus)): ?>

       	<?php if($automatchStatus->interval ==1 ): ?>
       	<a style="" href="<?php echo e(URL::to('/admin/automatch/start')); ?>" class="btn btn-primary">Launch Automatching</a>
       	<?php endif; ?>

       	<?php if($automatchStatus->interval ==0 ): ?>
       	<a style="" href="<?php echo e(URL::to('/admin/automatch/pause')); ?>" class="btn btn-danger">Pause Automatching</a>
       	<?php endif; ?>


       <?php endif; ?>

       <a style="" href="<?php echo e(URL::to('/admin/timeout/block')); ?>" class="btn btn-danger">Run time out blockage</a>
       <a style="" href="<?php echo e(URL::to('/admin/updateMGI')); ?>" class="btn btn-danger">.</a>

       <!-- <a style="" href="<?php echo e(URL::to('/admin/trigger/automatch')); ?>" class="btn btn-primary">Force automatch</a>-->

   <a style="" href="<?php echo e(URL::to('/admin/user/list')); ?>" class="btn btn-success">View all registered users</a>
     ...
     <hr>
			<p class="alert alert-info">
			 Insurance Value : <?php echo e($insurance); ?> %


			</p>
<div>
<label>New insurance value:</label>

<form action="<?php echo e(URL::to('admin/insurance/update')); ?>" method="post">
...
<hr>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Latest Registered Users&nbsp;<span class="badge"><?php echo e($userNo-1); ?></span>
              ...
              <table id="example1" class="table table-hover">
               ...
               ?>
                ...
                <?php endif; ?>
                 ...
                 <a href="<?php echo e(URL::to('/admin/user/view/'.$user->id)); ?>"  class="btn btn-default">View</a>
			...
			<div class="container-fluid">
				<div class="page-header">
					...
					<div class="pull-right">
						...
						<li>
							<a  class='btn btn-danger' href="<?php echo e(URL::to('/admin/matchlist/blocktimedeclindedusers')); ?>">Block time declined users (all)</a>
						</li>
