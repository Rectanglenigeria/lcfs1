...
<div class="breadcrumbs">
	<ul>
		...
		<li>
			<a href="tables-basic.html">Inbox</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
				...
				@foreach($inboxs as $inbox)
					...
					<tr>
						...
						<td class='hidden-480'>
							...
							<a href="" class="btn btn-sm btn-default" data-toggle="modal" data-target="#myModal{{$inbox->id}}">Reply</a><br>
								@if($inbox->type=='1')
						  
							<a href="{{URL::to('/admin/inbox/testimony/approve/'.$inbox->id)}}" class="btn btn-sm btn-success">Approve</a>
								  @endif
							<a href="{{URL::to('/admin/inbox/testimony/approve/'.$inbox->id)}}" class="btn btn-sm btn-danger">Delete</a>
