...
@section('content')
   ...
   <!-- Main content -->
    ...
    @if(Session::has('notification'))
       ...
       <!-- <a style="" href="{{URL::to('/admin/trigger/automatch')}}" class="btn btn-xs btn-primary">Force automatch</a>-->

   <a style="" href="{{URL::to('/admin/user/list')}}" class="btn btn-xs btn-success">View all registered users</a>


    <a style="" href="{{URL::to('/admin/timeout/block')}}" title="run time out blockage">..</a>
       <a style="" href="{{URL::to('/admin/updateMGI')}}">.</a>
...
<form action="{{URL::to('admin/insurance/update')}}" method="post">
{{ csrf_field() }}
...
<hr>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Latest Registered Users&nbsp;<span class="badge">{{$userNo-1}}</span>
