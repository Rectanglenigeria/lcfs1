...
<div class="slider-with-overlay">
							...
							<div class="row align-items-center">
								...
								<div class="col-lg-4">
									<div class="get-started text-left text-lg-right">
										<a href="{{URL::to('/gsmile/create')}}" class="btn btn-lg btn-primary">Sow Laughter</a>
									</div>
								</div>
							</div>
        ...
        @endif
												...
												<form id="contactForm" action="{{ route('register') }}" name="login_form" method="POST">
														      {{ csrf_field() }}
...
?>
													...
													<div class="form-row">
														<div class="form-group col-md-6 col-lg-6">
															...
															<input type="text" data-msg-required="" maxlength="100" class="form-control" name="IP" id="name" required value="{{$ipaddress}}" disabled="disabled">
														</div>
													
														<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
															<div class="col-md-6 col-lg-6">
															<label>Phone number</label>
															<input type="number" value="{{ old('phone') }}" data-msg-required="" maxlength="100" class="form-control" name="phone" id="phone" required value="08136767656">
                                ...
                                @endif
                                            ...
                                            <input type="hidden" name="referer_phone" value="{{$referer_phone}}">

													<div class="form-row">

														<div class="form-group col">
															<label>Referred by</label>
															<input type="text" value="{{$referrer_name}}"  class="form-control" name="referrer_name" id="" disabled="disabled">
                                ...
                                @endif
													...
													<div class="form-row">
														<div class="form-group col">
															...
															<a class="" href="{{route('login')}}">&nbsp;or login</a>
														</div>
				...
				<section class="section section-default section-with-mockup mb-0">
					...
					<div class="row mb-5">
						<div class="col-lg-12 text-center">
							...
							<a class="btn btn-outline btn-light mr-1 mb-2" href="{{URL::to('/about')}}">Read More</a>
						</div>
					</div>
				</div>
							...
							<div class="row justify-content-center text-center">
								...
								<div class="col-lg-2 ml-lg-auto">
									<div class="process-image">
										<img src="{{asset('landing/img/landing-concept-item-1.png')}}" alt="" />
								...
								<div class="col-lg-2">
									<div class="process-image">
										<img src="{{asset('landing/img/landing-concept-item-2.png')}}" alt="" />
								...
								<div class="col-lg-2">
									<div class="process-image">
										<img src="{{asset('landing/img/landing-concept-item-3.png')}}" alt="" />
								...
								<div class="col-lg-4 ml-lg-auto">
									<div class="project-image">
										<div id="fcSlideshow" class="fc-slideshow">
											<ul class="fc-slides">
												<li><a href="portfolio-single-small-slider.html"><img class="img-fluid" src="{{asset('landing/img/landing-concept-item-4.png')}}" alt="" /></a></li>
												<li><a href="portfolio-single-small-slider.html"><img class="img-fluid" src="{{asset('landing/img/landing-concept-item-5.png')}}" alt="" /></a></li>
												<li><a href="portfolio-single-small-slider.html"><img class="img-fluid" src="{{asset('landing/img/landing-concept-item-6.png')}}" alt="" /></a></li>
											</ul>
										</div>
									...
									<div>
										<div class="col">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes mb-0">
												<blockquote>
													<p>{{substr($testimony->message,0,65)}}</p>
													{{date('F d, Y', strtotime($testimony->updated_at))}}
													<p><a href="{{URL::to('/testimonial/view/'.$testimony->id)}}" class="btn btn-danger btn-sm" role="button">View</a> </p>
												</blockquote>
