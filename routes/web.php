...
Route::group(['middleware'=>['auth','completeProfile','is_block']], function(){
	...
	Route::get('/matches/remove_defaulter/{match_id}','UserDashboardController@removeDefaulter');
	...
	Route::get('/download/{fParam}','DownloadController@create');
...
{
	Route::get('/cronjob/execute', 'Admin\CronjobController@execute');
	...
	Route::get('user/make_el/{id}', 'Admin\UserController@makeEarlyReaper');

	Route::get('user/unmake_el/{id}', 'Admin\UserController@unmakeEarlyReaper');
	...
	Route::post('/matches/confirmpayment','Admin\MatchuserController@ConfirmPayment');


	Route::get('/updateMGI','Admin\BgController@updateMGI');
