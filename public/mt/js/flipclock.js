$(document).ready(function() {
	var launchingDate=new Date("August 4, 2017 12:00:00");
	var now =new Date();
	var duration = new Date(launchingDate - now);
	var days=duration.getDate();
	var hours=duration.getHours();
	var minutes=duration.getMinutes();
	var seconds=duration.getSeconds();
	var FlipClockFormat="'"+days+":"+hours+":"+minutes+":"+seconds+"'";
	
  var flip = new FlipClock({
    isCountdown: true,
    startTime: FlipClockFormat /*'31:00:00:05'*/,
