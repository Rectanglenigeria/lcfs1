...
//echo $pioneer_id;   
        ...
        $new_rsLeftAmount=$left_amount_of_pioneer_rs - $insuranceAmount;
                        ...
                        if($new_rsLeftAmount<0){
                            ...
                            $messageAdmin->email="admin@smilesteadily.com";
                            $messageAdmin->title="Insurance matching difficulty";
                            $messageAdmin->body="Unable to matching remaining smile of pioneer. Name:".$pioneer->name." Rsmile value=".$pioneer_rsmile->amount." Date Create =".$pioneer_rsmile->created_at.". Help match him.";
